...
public class HospitalSystem {
    ...
    public HospitalSystem(NodeDao nodeDao, EdgeDao edgeDao, LocationDao locationDao, MoveDao moveDao, ConferenceRoomRequestDAO conferenceRoomRequestDAO, EmployeeDao employeeDao, FlowerDeliveryRequestDAO flowerDeliveryRequestDAO, FurnitureDeliveryRequestDAO furnitureDeliveryRequestDAO, MealRequestDAO mealRequestDAO, OfficeSuppliesRequestDAO officeSuppliesRequestDAO){
