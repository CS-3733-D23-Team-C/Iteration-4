    ...
    public List<Alert> fetchAllObjects()  {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Alert request =
                        new Alert(id, title, description, type, startdate, enddate);
       ...
       Alert alert = null;
         try {
              ...
              ps.executeUpdate();
                ...
                if (rs.next()) {
                    alert = new Alert(rs.getInt(1), type.getTitle(), type.getDescription(), type.getType(), type.getStartdate(), type.getEnddate());
