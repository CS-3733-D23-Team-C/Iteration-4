...
public class GiftBasketRequest extends AbsServiceRequest {
    ...
    public GiftBasketRequest(int requestID, IUser requester, String roomName, String note, GiftBasket gift) {
    ...
    public GiftBasketRequest(IUser requester, String roomName, String note, GiftBasket giftl, String eta) {
        super(requester, roomName, note);
        this.gift = gift;
        this.eta = eta;
    }
