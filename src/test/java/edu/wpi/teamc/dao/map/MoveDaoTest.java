...
public class MoveDaoTest {
  ...
  public void updateRow() {
    MoveDao moveDao = new MoveDao();
    Move moveOrm = new Move("100", "Hallway 10 Floor L1", new Date(2023, 4, 9));
    Move moveRepl = new Move("100", "Hallway", new Date(2023, 4, 9));
  ...
  public void addRow() {
    MoveDao moveDao = new MoveDao();
    Move moveOrm = new Move("4000", "Hallway 4000", new Date(2023, 4, 9));
